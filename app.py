...
pipe = pickle.load(open('pre.pkl','rb'))
...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'batting_team':[batting_team],'bowling_team':[bowling_team],'city':[selected_city],'runs_left':[runs_left],'balls_left':[balls_left],'wickets_remaining':[wickets],'total_run_x':[target],'crr':[crr],'rrr':[rrr]})
